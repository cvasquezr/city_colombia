...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-05-2017 a las 04:29:27
...
CREATE TABLE `departamentos` (
  `id_departamento` int(11) NOT NULL COMMENT 'Identificación del departamento',
  `nombre_departamento` varchar(50) COLLATE utf8_spanish2_ci NOT NULL COMMENT 'Nombre del departamento'
...
CREATE TABLE `municipios` (
  `id_municipio` int(11) NOT NULL COMMENT 'Llave del municpio',
  `nombre_municipio` varchar(55) COLLATE utf8_spanish2_ci NOT NULL COMMENT 'Nombre del municipio',
  `id_departamento` int(11) NOT NULL COMMENT 'Departamento al que pertenece el municipio'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
ALTER TABLE `departamentos`
  ...
  ADD UNIQUE KEY `iddepartamentos_UNIQUE` (`id_departamento`);
...
ALTER TABLE `municipios`
  ...
  ADD UNIQUE KEY `id_municipios_UNIQUE` (`id_municipio`),
...
--
ALTER TABLE `departamentos`
  MODIFY `id_departamento` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificación del departamento', AUTO_INCREMENT=33;
--
-- AUTO_INCREMENT de la tabla `municipios`
--
ALTER TABLE `municipios`
  MODIFY `id_municipio` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave del municpio', AUTO_INCREMENT=1103;
--
...
--
ALTER TABLE `municipios`
  ADD CONSTRAINT `id_departamento` FOREIGN KEY (`id_departamento`) REFERENCES `departamentos` (`id_departamento`) ON DELETE NO ACTION ON UPDATE NO ACTION;
